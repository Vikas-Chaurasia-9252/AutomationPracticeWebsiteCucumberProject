...
public class ProductsPage {
     ...
     private By allProductHeading = By.xpath("//h2[text()='All Products']");
     ...
     private By productPageLink = By.xpath("//a[text()=' Products']");
    ...
    public void navigateToProductPage(){
        ...
        util.waitForElementTobeVisible(allProductHeading);
    ...
    public void addProductToCart(String productTobeAdded){
        ...
        for(WebElement ele : productList){
            System.out.println("Current Product name: "+ele.getText());
            if(ele.getText().equalsIgnoreCase(productTobeAdded)){
                System.out.println("Product Found!!");
                WebElement addToCartBtn = driver.findElement(By.xpath("//div[@class='productinfo text-center']/p/following-sibling::a"));
